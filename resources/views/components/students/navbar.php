<nav class="flex justify-between items-center bg-blue-100 px-6 py-4 border-b border-gray-300">
        <!-- Logo Section -->
        ...
        <div>
            <div class="flex items-center space-x-2">
                <img src="https://tutor-match.com/wp-content/uploads/2024/03/cropped-Tutor_Match1-removebg-preview-removebg-preview-1.png" alt="Logo" class="w-10 h-10">
