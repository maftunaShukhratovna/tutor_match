...
<body class="bg-white">
    ...
    <div class="flex h-full">
        ...
        <div class="w-1/4 bg-white shadow-md p-6">
            ...
            <ul class="space-y-2">
                <li><button onclick="showSection('courses')"
                        class="w-full text-left text-blue-600 hover:underline">Courses</button></li>
            </ul>

            <h2 class="text-gray-500 font-semibold mt-6 mb-4">MY ACCOUNT</h2>
            <ul class="space-y-2">
                <li><button onclick="showSection('progress')"
                        class="w-full text-left text-gray-700 hover:underline">Progress</button></li>
                <li><button onclick="showSection('profile')"
                        class="w-full text-left text-gray-700 hover:underline">Profile</button></li>
                <li><button onclick="showSection('teachers')"
                        class="w-full text-left text-gray-700 hover:underline">Teachers</button></li>
            </ul>
        </div>
            ...
            <div id="courses" class="content">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="border border-gray-200 rounded-lg shadow-sm p-4">
                        ...
                        <ul class="mt-3 space-y-2 text-sm text-gray-600">
                            <li>Exploring categorical data - <span class="font-medium text-gray-800">52% Mastered</span>
                            </li>
